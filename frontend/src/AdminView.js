...
const AdminView = props => {
    ...
    const handleAddition = () => {
        const courts = { 'court1': 0, 'court2': 1, 'court3': 2, 'court4': 3, 'court5': 4, 'court6': 5 };
        if (court !== '') {
            const msg = { type: "action", action: "court-add", value: selected, court: courts[court] };
            props.wsSend(JSON.stringify(msg));
            setSelected([]);
        }
    };
    ...
    return (<Container maxWidth="sm">
        ...
        <Box m={0.5} p={0.5}><FormControl fullWidth>
