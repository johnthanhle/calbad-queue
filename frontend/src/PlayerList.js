    ...
    <Container maxWidth="sm">
      ...
      <Box sx={{ p: 2, border: "0.25px dashed grey" }}>
        <h4>
          ...
          your infomration, click the the black checkbox to confirm. You will
          not be able to join the queue until this has been done. If there is
          currently a challenge court and you want to queue on the challenge
          court, please indicate "Yes" in the challenge select box. Lastly, we
          are sorry if we incorrectly pronounce your names.
        </h4>
      </Box>
      {user && (
        <PlayerInfo
